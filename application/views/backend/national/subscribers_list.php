        ...
        <div class="row-fluid">
			<div class="span12">
              ...
              <tr>
               ...
               <?php  if( $this->session->userdata('role') =='webadmin'):           
                echo '<td width="175" class="crud-actions" align="center">  Action</td>';
				endif;
				?>                                     
              </tr>
            </thead>
            <tbody>
              ...
              {	
				...
				if($res_pay['Mode_of_pay']=='cash' || $res_pay['Mode_of_pay']=='cheque' || $res_pay['Mode_of_pay']=='Cash' )
				{
				echo '<a href="national/subscribers_payment/'.$row['id'].'/'.$this->uri->segment(3).'" class="btn btn-info">Update</a>';
				}
                echo '</td></tr>';
              }
              ?>      
