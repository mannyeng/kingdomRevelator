...
<body class="lock">
    ...
    <div class="login-wrap" style="margin: 3% 24%;">
        ...
        <?php  } ?>
        <form action="login/forgotpass" method="post" name="f1">
                ...
                <div class="input-append lock-input">
                    ...
                    <!-- <table width="100%" cellpadding="2">
                        ...
                        <div class="input-append lock-input" style="margin-top: 7%;">
                            ...
                            <input type="hidden" name="role" id="role" autocomplete="off"  placeholder="Email" value='state_zone'/>
                            <br>
                            <div class="col-lg-6 col-md-6 col-lg-offset-3">
                                Back to Login <a href="<?php echo base_url('state_zone_login');?>">Click here</a>
                            </div>
                        </div>
