...
<body class="lock">
    ...
    <?php
        ...
        if($role=='Article')
        {
            $home   = 'front_login/art_login';
            $action = 'login/forgotpass/Article';
        }
        if($role=='Distributer')
        {
            $home   ='front_login/dist_login';
            $action = 'login/forgotpass/Distributer';
        }
        if($role=='Intercession')
        {
            $home   ='front_login/int_login';
            $action = 'login/forgotpass/Intercession';
        }
    ?>
    <div class="login-wrap" style="margin: 3% 24%;">
        ...
        <?php  } ?>
        <form action="<?php echo $action;?>" method="post" name="f1">
                ...
                <div class="input-append lock-input">
                    ...
                    <!-- <table width="100%" cellpadding="2">
                        ...
                        <div class="input-append lock-input" style="margin-top: 7%;">
                            ...
                            <input type="hidden" name="role" id="role" autocomplete="off"  placeholder="Email" value='<?php echo $role; ?>'/>
                            <br>
                            <div class="col-lg-6 col-md-6 col-lg-offset-3">
                                Back to Login <a href="<?php echo base_url($home);?>">Click here</a>
                            </div>
                        </div>
