...

{
	...
	if($this->session->userdata('role') == 'state')

	$this->db->where('State_admin_id',$this->session->userdata('id'));

	$this->db->join('kr_distributers','kr_distributers.id=kr_users.Distributer_id','Inner');

	$user = $this->db->get_where('kr_users',array('kr_users.id'=>$id,'kr_users.admin_type'=>'state_zone'))->row_array();
                                    ...
                                    <div class="span6">
                                       ...
                                       <div class="control-group">
                                            ...
                                            <div class="controls">
											   ...
											   if(($this->session->userdata('role') == 'national') || ($this->session->userdata('role') == 'zone') || ($this->session->userdata('role') == 'state')) {?>
                                           ...
                                           <div class="control-group">
                                            ...
                                            <div class="controls">
											   ...
											   ?>
                                                ...
                                                <select name='Zonal_admin_id' id='Zonal_admin_id' class="span10" required="required" onchange="get_state($(this).val())"> 
                                                ...
                                                <option value="">Select</option> 
...

												 {
                                                  ...
                                                  <input type="hidden" name="National_admin_id" value="<?php echo $zone['id'];?>"> 
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
											   ...
											   ?>
                                                ...
                                                <select name='State_admin_id' id='State_admin_id' class="span10" required="required" <?php if ($this->uri->segment(3)){?> onchange="state_select_update($(this).val(),<?php echo $this->uri->segment(3); ?>);" <?php }else{?> onchange="state_select($(this).val());" <?php } ?>> 
                                                ...
                                                <option value="">Select</option> 
                                                    ...
                                                    <option value='<?php echo $key['id']; ?>' <?php if(@$user['State_admin_id']==$key['id']){ echo "selected"; } ?>><?php echo $key['Name']; ?></option>
...

												 {
												  ...
												  <label class="control-label" for="name"><?php echo ucfirst($state['Name']); ?></label>

                                                  <input type="hidden" name="State_admin_id" value="<?php echo $state['id'];?>"> 
                                      ...
                                      <div class="control-group">
                                            ...
                                            <label class="control-label" for="code">State Zone Name</label>

                                            <div class="controls">

                                                <div class="input-append span10" >

                                                <input type="text" class="span10" id="First_name" name="Name" value="<?php echo @$user['Name']; ?>" required="required" onblur="duplicate_state_zone($(this).val())" >
...
function duplicate_state_zone(value)

{
	...
	$.ajax({
		...
		url:"Ajaxaction/duplicate_state_zone",
...

		{
			...
			if($msg=='State zone already exist.')
...
$(function(){
	...
	$('#National_admin_id').on('change',function(){
		...
		$('#Zonal_admin_id').on('change',function(){

		var field='Zonal_admin_id';
