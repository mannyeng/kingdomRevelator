								...
								<div class="control-group">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											...
											<?php  
											echo form_dropdown('role', array('national'=>'National Coordinator','finance'=>'Finance Admin','zone'=>'Zone Coordinator','state'=>'State Coordinator','county'=>'County Coordinator','Distributer'=>'Distributer'), @$user['admin_type'],array('id'=>'roles','required'=>'required'));
                                    ...
                                    <div class="control-group" id='zone'  <?php if(@$user['Zonal_admin_id']!="" ){  if(@$user['Zonal_admin_id']!=0 ){ echo "style='display:block;'"; } else{ echo "style='display:none;'"; }} else{ echo "style='display:none;'"; } ?>>
                                    ...
                                    <div class="control-group" id='state' <?php if(@$user['State_admin_id']!="" ){ if(@$user['State_admin_id']!="0" ){ echo "style='display:block;'"; }else{ echo "style='display:none;'"; }} else{ echo "style='display:none;'"; } ?>>
...
$(function(){
	$("#roles").on('change',function(){
		var valu=$(this).val();
		if(valu =="national" || valu=="finance" || valu=="Distributer")
		{
			$("#state").hide();
			$("#zone").hide();
			$("#county").hide();
