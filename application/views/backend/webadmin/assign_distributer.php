...
<?php
      ...
      echo form_open('webadmin/assign_distributers', $attributes);

      ?>

							<fieldset>

                              <div id='message'><?php if($this->session->flashdata('alert')=='success'){?><div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button>You have <strong>Assigned the Distibuter</strong> successfully  <a href="javascript:void(0)" class="alert-link"></a></div> <?php } ?></div>
								...
								<div class="span6">
									...
									<div class="control-group">
										...
										<div class="controls">
                                        	...
                                        	<select name='state_zone' id='state_zone' required >

                                             <option value=''>Select State zone</option>

                                            	<?php

												foreach($state_zone as $key)
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
                                        	...
                                        	<select name='Distributers[]' id='Distributers' multiple="multiple" required>
                                                ...
                                                <option value='<?php echo $row['userid']; ?>'><?php echo $row['First_name']; ?></option>
							...
							<div class="center">
                                ...
                                <input type="hidden" name='state_zone_id' class="btn btn-success" tabindex="8" value="<?php echo $this->uri->segment(3); ?>" />
