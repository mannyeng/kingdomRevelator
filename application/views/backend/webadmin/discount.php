					...
					<div class="widget-body">
						...
						<form action="" method="post" class="form-horizontal" id="form-validate">
                              ...
                              <div id='message'><?php if($this->session->flashdata('alert')=='success'){?><div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button>You have <strong>Added Discount</strong> successfully  <a href="javascript:void(0)" class="alert-link"></a></div> <?php } ?><?php if($this->session->flashdata('alert')=='updated'){?><div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button>You have <strong>Updated User</strong> successfully  <a href="javascript:void(0)" class="alert-link"></a></div> <?php } ?><?php if($this->session->flashdata('alert')=='Error'){?><div class="alert alert-dismissible alert-error"><button type="button" class="close" data-dismiss="alert">×</button><strong>Email</strong> already exist <a href="javascript:void(0)" class="alert-link"></a></div> <?php } ?></div>
								...
								<div class="control-group">
                                    ...
                                    <div class="control-group">
										...
										<label class="control-label" for="code">Price per copy 1-year</label>

										<div class="controls">

											<div class="input-append span10" >

											<input type="text" class="span10 noquote" id="price_1_yr" pattern="[0-9]+" maxlength="3" name="price_1_yr" value="<?php echo @$price['1_yr_price']; ?>" required="required" >
                                     ...
                                     <div class="control-group">
										...
										<label class="control-label" for="code">Price per copy 2-year</label>

										<div class="controls">

											<div class="input-append span10" >

											<input type="text" class="span10 noquote" id="price_2_yr" pattern="[0-9]+" maxlength="3" name="price_2_yr" value="<?php echo @$price['2_yr_price']; ?>" required="required" >
                                     ...
                                     <div class="control-group">
										...
										<label class="control-label" for="code">Minimum copies for distribution</label>

										<div class="controls">

											<div class="input-append span10" >

											<input type="text" class="span10 noquote" id="min_cpy" pattern="[0-9]+" maxlength="3" name="min_cpy" value="<?php echo @$user['min_cpy']; ?>" required="required" >
                                    ...
                                    <div class="control-group">
										...
										<label class="control-label" for="code">Price per copy for distribution</label>

										<div class="controls">

											<div class="input-append span10" >

											<input type="text" class="span10 noquote" id="price_cpy" pattern="[0-9]+" maxlength="3" name="price_cpy" value="<?php echo @$user['price_cpy']; ?>" required="required" >
							...
							<div class="center">
								...
								<input type="submit" class="btn btn-success"  tabindex="8" value="<?php if ($this->uri->segment(3)) { ?>Update<?php } else { ?>Add<?php } ?> " />
