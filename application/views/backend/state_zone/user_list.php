								...
								foreach ($users as $user) {
									...
									<tr>
										...
										<td class="actions center">
											<a class="btn btn-edit" href="state/user_add/<?php echo $user['id']; ?>"><i class="icon-edit icon-white"></i> Edit</a>
											<a class="btn btn-danger del" href="state/user_add/<?php echo $user['id']; ?>"><i class="icon-trash icon-white"></i> Delete</a>
										</td>
									</tr>
									<?php
								}
