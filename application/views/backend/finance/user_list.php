	...
	<div class="container-fluid">
        ...
        <div class="row-fluid">
          ...
          <div class="well">
            ...
            echo form_open('national/user_list/'.$this->uri->segment(3), $attributes);
        ...
        <p><a href="national/export_users/<?php echo $this->uri->segment(3);?>" class="btn btn-danger">Export</a></p>
								...
								foreach ($users as $user) {
									...
									?>
										...
										<td class="actions center">
											<a class="btn btn-edit" href="national/user_add/<?php echo $user['id']; ?>"><i class="icon-edit icon-white"></i> Edit</a>
											<a class="btn btn-danger del" href="national/user_delete/<?php echo $user['id']; ?>"><i class="icon-trash icon-white"></i> Delete</a>
										</td>
									</tr>
									<?php
								}
