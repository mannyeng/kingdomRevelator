...
<?php */?>        <div class="row-fluid">
			<div class="span12">
				...
				<div class="widget blue">
                    ...
                    <form method="post" action="national/subscribers_payment/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>">
            ...
            <tbody>
              <?php
			  	$row        = $this->db->get_where('kr_subscribers',array('id'=>$this->uri->segment(3)))->row_array();
				$res_pay    = $this->db->get_where('kr_payment',array('Subscriber_id'=>$this->uri->segment(3)))->row_array();
