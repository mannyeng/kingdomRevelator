		...
		<div class="row-fluid">
			<div class="span12">
				...
				<ul class="breadcrumb">
                    ...
                    <li>
						<a href="zone/state_list">State List</a>
						<span class="divider">/</span>
					</li>
                    <li>
						<a href="zone/state_zone_list">State Zone</a>
						<span class="divider">/</span>
					</li>
					<li class="active">
						County List
...
-->        <div class="row-fluid">
			<div class="span12">
              ...
              <tr>
                ...
                <th width="" class="red header" align="center">Distributers</th>
              </tr>
            </thead>
            <tbody>
              <?php
              foreach($county as $ind=>$row)
              {	
            ...
            //    echo '<td class="crud-actions" align="center">
                //  <a href="groups/update/'.$row['retreat_id'].'/'.$row['group_id'].'" class="btn btn-info">Edit</a>&nbsp;';				  				//else:
				   echo '<td class="crud-actions" align="center">
                 <a href="zone/distributers_list/'.$row['id'].'" class="btn btn-info">view</a>&nbsp;';
				//endif;
                echo '</td></tr>';
              }
              ?>      
