...
?>
 ...
 <table width="100%" cellpadding="2">
     <tr>
        ...
        <td align="right"><input type="radio" name="role" checked value="state" onClick="document.getElementById('state_div').style.display = 'block';document.getElementById('state_zone_div').style.display = 'none';" id="role_3"></td>
        <td align="left">State
        <td align="right"><input type="radio" name="role" value="state_zone" onClick="document.getElementById('state_div').style.display = 'none';document.getElementById('state_zone_div').style.display = 'block';" id="role_3"></td>
   ...
   <div class="input-append lock-input" >
   <input type="text" name="user_name" id="user_name" autocomplete="off"  placeholder="Username" required/>
                    <input type="password" name="password" autocomplete="off" id="password"  placeholder="Password" required/>
                     <span id='state_div'><br> Forgot Password?<a href="login/forgotpass/state">Click here</a></span>
                     <span id='state_zone_div' style="display:none;"><br> Forgot Password?<a href="login/forgotpass/state_zone">Click here</a></span>

                    <!--<div class="input-append lock-input" style="margin-top:10px;" id="security_q" >
                    <input type="password" name="security_a" id="security_a"  placeholder="Enter security question" />
                </div>-->
                </div>
