...
?>
  ...
  <!-- <table width="100%" cellpadding="2">
   ...
   <div class="input-append lock-input" style="margin-top: 13%;">
   <input type="text" name="user_name" id="user_name" autocomplete="off"  placeholder="Username" required/>
                    ...
                    <input type="hidden" name="role" autocomplete="off" id="role"  placeholder="Password" value="zone" />
                   <br> Forgot Password?<a href="login/forgotpass/zone">Click here</a>
