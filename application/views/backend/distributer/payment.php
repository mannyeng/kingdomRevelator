				...
				<div class="widget blue">
					...
					<div class="widget-body">
                        ...
                        <form class="form-horizontal" id='volunteer_form' method="POST" >
							...
							Total Amount : $ <?php echo $amount['paid_amnt'];?>

								  <div class="control-group">

                    <label class="col-lg-4 col-md-2 control-label label-style" style="margin-top:5px;">Mode of Payment </label>

     					<input type="hidden" class="span10" name="amount" id="" value="<?php echo $amount['paid_amnt'];?>">

                    <div class="col-lg-8 col-md-10" style="display: inline-flex;">

                      <div class=" radio-primary" style="padding-right: 13%;display: block;">
                      ...
                      <div class="radio-primary" style="padding-right: 10%;">
...

{
	...
	$('#cash_agent_name').attr('required','true');
	...
	$('#cheque_agent_name').attr('required','true');
