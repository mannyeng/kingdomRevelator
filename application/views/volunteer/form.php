...

{
	...
	$('#State').attr('style', 'color: black !important;font-weight: 400 !important');    
...

{
	...
	if($('#First_name').val()=='' || $('#password').val()=='' || $('#day').val()=='' || $('#hour').val()=='' || $('#min').val()==''  || $('#Last_name').val()==''|| $("#valid_email").val()=='Email address already exist.' || $('#Address1').val()==''  || $('#City').val()=='' || $('#State').val()=='' || $('#Zipcode').val()=='' || $('#Phone_Number_H').val()=='' || $('#Phone_number_C').val()=='' || $('#Email').val()=='' || $('#password').val()=='' || $('#Copies_requested').val()=='' || !$.isNumeric($('#Copies_requested').val()) || $('#payment_type_cash').css('display') != 'none' && $('#cash_agent_name').val()==''||  $('#request_month').val()=='' || $('#payment_type_cheque').css('display') != 'none' && $('#cheque_agent_name').val()=='')

	{
		...
		else if($('#Copies_requested').val()=='')

		{

			$('#Copies_requested').parents('.col-lg-10').parent().addClass('has-error is-focused');

			$('#Copies_requested').css('color','red');

			$('#Copies_requested').focus();

		}

    else if(!$.isNumeric($('#Copies_requested').val()))

    {
      ...
      $('#Copies_requested').focus();
		...
		else if($('#request_month').val()=='')

		{

			$('#request_month').parents('.col-lg-10').parent().addClass('has-error is-focused');

			$('#request_month').css('color','red');
...
function email_check()
{
	...
	$.ajax({
		...
		data:'email='+$("#Email").val()+'&type=Distributer',
        ...
        <div class="well bs-component">
           ...
           <br />
            ...
            <fieldset>
              ...
              <legend style="background:#574b31;"> <center>REGISTER AS KR BULK SUBSCRIBER</center></legend>
              ...
              { ?>
               ...
               { 
                ?>
                <div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button>You have <strong>Registered</strong> successfully  <a href="javascript:void(0)" class="alert-link"></a></div> 
                <?php 
                } 
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10 col-md-10 col-lg-offset-1">
                    ...
                    <input type="text" class="form-control" id="Phone_Number_H" name='Phone_Number_H' value='' minlength='10'  maxlength='10' pattern='[0-9]{10}' title="Enter 10 digit number" placeholder=" Phone Number(Home)">
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10 col-md-10 col-lg-offset-1">
                    ...
                    <input type="text" class="form-control" id="Phone_number_C" name='Phone_Number_C' value='' minlength='10'  maxlength='10' pattern='[0-9]{10}' title="Enter 10 digit number" placeholder=" Phone number (Cell)">
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10 col-md-10 col-lg-offset-1">
                    ...
                    <input type="email" class="form-control" id="Email" name='Email' value='' autocomplete="off" placeholder=" Email" onkeyup="email_check();" />
              ...
              <legend style="background:#574b31;"><center><?php echo strtoupper("Copies Requested For Distribution");?></center></legend>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10 col-md-10 col-lg-offset-1">
                    ...
                    <input type="text" class="form-control" id="Copies_requested" maxlength="3" name='Copies_requested' value='' onkeyup="getDiscount($(this).val(),'')"  placeholder="Please enter number copies">
...
<!--              <div class="col-lg-10 col-md-10 col-lg-offset-1">
                  ...
                  <b style="color:#990099">Time Commitment (Time / Day)</b>
                  ...
                  <div class="col-lg-2 col-md-2 col-lg-offset-1">
                    ...
                    <input type="text" class="form-control dat" id="day"   name='day[0]' placeholder="Select Date" required />
...
-->              <div class="form-group">
                ...
                <div class="col-lg-4 col-md-4  col-lg-offset-4 col-md-offset-4">
                  ...
                  <button type="submit" class="btn btn-primary" id="ADD" disabled name='ADD'>Submit</button>
