...
class Common extends CI_model {
	...
	public function subscribers_orders_list($string,$user,$from,$to)
	{
		//echo "SELECT s.`Subscriber_id`, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`BillingAddress1`, s.`BillingAddress2`, s.`BillingCity`, s.`BillingState`, s.`BillingZip`, s.`Home_phone`, s.`Email_address`, s.`Distributer_id`,o.*, SUM( o.No_of_copies ) as Total_copies FROM kr_orders o Left Join kr_subscribers s on s.id=o.Subscriber_id WHERE o.Subscriber_id='1' and  DATE_FORMAT(o.expiry_date,'%Y-%m-%d')<'$to' and  DATE_FORMAT(o.expiry_date,'%Y-%m-%d')>'$from'";exit();
		if($string!='' && $from!='' && $to!='')
		{
	...
	public function distributer_orders_list($string,$user,$from,$to)
	{
		//echo "SELECT s.`Subscriber_id`, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`BillingAddress1`, s.`BillingAddress2`, s.`BillingCity`, s.`BillingState`, s.`BillingZip`, s.`Home_phone`, s.`Email_address`, s.`Distributer_id`,o.*, SUM( o.No_of_copies ) as Total_copies FROM kr_orders o Left Join kr_subscribers s on s.id=o.Subscriber_id WHERE o.Subscriber_id='1' and  DATE_FORMAT(o.expiry_date,'%Y-%m-%d')<'$to' and  DATE_FORMAT(o.expiry_date,'%Y-%m-%d')>'$from'";exit();
		if($string!='' && $from!='' && $to!='')
		{
			$res_subscribe = $this->db->query("SELECT s.`disributer_id` as sub_id, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`Email_address`, s.`User_id`,o.*, o.No_of_copies as Total_copies FROM kr_dis_orders o Left Join kr_distributers s on o.Distributer_id=s.disributer_id WHERE s.`disributer_id`='$string' and DATE_FORMAT(o.expiry_date,'%Y-%m-%d')<'$to' and  DATE_FORMAT(o.expiry_date,'%Y-%m-%d')>'$from'");
			 return $res_subscribe->result_array();
		}
		elseif($string!='')
		{
			$res_subscribe = $this->db->query("SELECT s.`disributer_id` as sub_id, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`Email_address`, s.`User_id`,o.*, o.No_of_copies as Total_copies FROM kr_dis_orders o Left Join kr_distributers s on o.Distributer_id=s.disributer_id WHERE s.`disributer_id`='$string'");
		...
		{
			 $zoneid   = $user;
			 $res_subscribe = $this->db->query("SELECT s.`disributer_id` as sub_id, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`Email_address`, s.`User_id`,o.*,o.No_of_copies as Total_copies FROM kr_dis_orders o Left Join kr_distributers s on o.Distributer_id=s.disributer_id WHERE DATE_FORMAT(o.expiry_date,'%Y-%m-%d')<'$to' and  DATE_FORMAT(o.expiry_date,'%Y-%m-%d')>'$from'");
			 return $res_subscribe->result_array();
		}
		else
		{
			//echo "SELECT s.`disributer_id` as sub_id, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`Email_address`, s.`User_id`,o.*, SUM( o.No_of_copies ) as Total_copies FROM kr_dis_orders o Left Join kr_distributers s on o.Distributer_id=s.User_id  group by o.Distributer_id";
			 $zoneid   = $user;
			 $res_subscribe = $this->db->query("SELECT s.`disributer_id` as sub_id, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`Email_address`, s.`User_id`,o.*,o.No_of_copies as Total_copies FROM kr_dis_orders o Left Join kr_distributers s on o.Distributer_id=s.disributer_id ");
			// echo "SELECT s.`disributer_id` as sub_id, s.`First_name`, s.`Last_name`, s.`Mailing_address1`, s.`Mailing_address2`, s.`City`,s.`State`, s.`Zipcode`, s.`Email_address`, s.`User_id`,o.*,o.No_of_copies as Total_copies FROM kr_dis_orders o Left Join kr_distributers s on o.Distributer_id=s.disributer_id  group by o.Distributer_id";
			 return $res_subscribe->result_array();
		}
	}
}
