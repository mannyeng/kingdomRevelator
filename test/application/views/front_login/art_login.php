...
<div class="col-lg-12 col-md-12 padding-zero">
  <div class="well bs-component">
    ...
    <br />
    <form class="form-horizontal" id='subscriber_form' action='art_login' method="POST" onSubmit="return subscribe();">
      <fieldset>
        <legend style="background:#b4501f;"><center>LOG IN FOR ARTICLE WRITING</center></legend>
        ...
        <div class="form-group has-success label-floating is-empty">
          <div class="col-lg-6 col-md-6 col-lg-offset-3">
            <label for="Username" class="control-label" style="color:#b4501f!important;">Email</label>
            <input type="text" class="form-control" name='username' id="username" vk_16387="subscribed">
          </div>
        </div>
        <div class="form-group has-success label-floating is-empty">
          <div class="col-lg-6 col-md-6 col-lg-offset-3">
            <label for="password" class="control-label" style="color:#b4501f!important;">Password</label>
            <input type="password" class="form-control" name='password' id="password" vk_16387="subscribed">
          </div>
        </div>
        <div class="form-group has-success label-floating is-empty">
          <div class="col-lg-6 col-md-6 col-lg-offset-3">
            Forgot Password?<a href="../login/forgotpass/Article">Click here</a>
          </div>
        </div>
        <center>
