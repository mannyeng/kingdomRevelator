								...
								<div class="control-group">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											...
											<?php  
											echo form_dropdown('role', array('state'=>'State Coordinator','county'=>'County Coordinator'), @$user['admin_type'],array('id'=>'roles','required'=>'required'));
                                    ...
                                    <div class="control-group" id='state'  <?php if(@$user['State_admin_id']!=0 ){ echo "style='display:block;'"; } else{ echo "style='display:none;'"; } ?>>
