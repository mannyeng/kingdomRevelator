  ...
  <div class="container-fluid">
    ...
    <!-- END PAGE HEADER-->
      <div class="metro-nav">
        ...
        <div class="metro-nav-block nav-block-green">
            <a href="<?php base_url();?>subscriber_profile/order_history/<?php echo sha1($orders['id']);?>">
        ...
        <?php if($this->Subscriber_model->expire_status($orders['id'])=='1') { ?>
        <div class="metro-nav-block nav-block-red">
            <a href="<?php base_url();?>subscriber_profile/order_edit/<?php echo sha1($orders['id']);?>">
