		...
		<div class="row-fluid">
			<div class="span12">
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="webadmin/state_list">State List</a>
						<span class="divider">/</span>
					</li>
                    <li>
                    ...
                    <li>
						<a href="webadmin/county_list">County List</a>
						<span class="divider">/</span>
					</li>
					<li class="active">
						Distributers List
...
-->        <div class="row-fluid">
            ...
            //    echo '<td class="crud-actions" align="center">
                //  <a href="groups/update/'.$row['retreat_id'].'/'.$row['group_id'].'" class="btn btn-info">Edit</a>&nbsp;';				  				//else:
				   echo '<td class="crud-actions" align="center">
                 <a href="webadmin/subscribers_list/'.$row['User_id'].'" class="btn btn-info">view </a>&nbsp;';
				//endif;
                echo '</td></tr>';
              }
              ?>      
