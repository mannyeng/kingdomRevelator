...
<?php
      ...
      echo form_open('webadmin/deallocate_distributers/'.$this->uri->segment('3'), $attributes);

      ?>

							<fieldset>

                              <div id='message'><?php if($this->session->flashdata('alert')=='success'){?><div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button>You have <strong>Deallocated the Distibuter</strong> successfully  <a href="javascript:void(0)" class="alert-link"></a></div> <?php } ?></div>

								<div class="span6">

									<div class="control-group">

										<label class="control-label" for="purchase_no"> State Zone</label>

										<div class="controls">

                                        	<select name='state_zone' id='state_zone' required onchange="distibuters(this.value);" >
                                    ...
                                    <div class="control-group">
										...
										<label class="control-label" for="purchase_no">Bulk Subscriber</label>

										<div class="controls">

                                        	<select name='Distibuters[]' id='distibuter' multiple="multiple" >
...
<select class="select span10" name="c_age[dyn_id]">
...

	{
		...
		$.ajax({
			...
			url:"Ajaxaction/distibuter",

			success:function getdistibuter($msg)

			{

				$('#distibuter').html('');

				$('#distibuter').append($msg);
