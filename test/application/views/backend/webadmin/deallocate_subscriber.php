...
<?php
      ...
      echo form_open('webadmin/deallocate_subscribers/'.$this->uri->segment(3), $attributes);

      ?>

							<fieldset>

                              <div id='message'><?php if($this->session->flashdata('alert')=='success'){?><div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button>You have <strong>Deallocated the Subscriber</strong> successfully  <a href="javascript:void(0)" class="alert-link"></a></div> <?php } ?></div>
								...
								<div class="span6">
									...
									<div class="control-group">
										...
										<div class="controls">
                                        	...
                                        	<select name='Distibuter' id='distibuter' required onchange="Subscribers(this.value);" >

                                             <option value=''>Select Bulk Subscriber</option>

                                            	<?php

												foreach($Distibuter as $key)
                                    ...
                                    <div class="control-group">
										...
										<label class="control-label" for="purchase_no"> Subscriber</label>

										<div class="controls">

                                        	<select name='Subscriber[]' id='Subscriber' multiple="multiple" >
