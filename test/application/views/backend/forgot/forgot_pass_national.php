                ...
                <div class="input-append lock-input">
                    ...
                    <!-- <table width="100%" cellpadding="2">
                        ...
                        <div class="input-append lock-input" style="margin-top: 7%;">
                            ...
                            <input type="hidden" name="role" id="role" autocomplete="off"  placeholder="Email" value='national'/>
                            <br>
                            <div class="col-lg-6 col-md-6 col-lg-offset-3">
                                Back to Login <a href="<?php echo base_url('national_login');?>">Click here</a>
                            </div>
                        </div>
                    </div>
