<div class="span12">
								...
								<form method="post" action="national/subs_refund_update_process">
									<table class="table table-striped table-bordered table-condensed" id="sample_1">

									
									<tr>
										<td><b>Refund Amount</b></td>
										<td><input type="text" class="form-control" name="refund_amnt" value="<?php echo $paymentdetails['refund_amnt'];?>"/><input type="hidden"  name="id" value="<?php echo $paymentdetails['id'];?>"/><input type="hidden"  name="urlids" value="<?php echo $orderid.'#'.$subsid.'#'.$distid;?>"/></td>
									</tr>
									<tr>
