<div class="span12">
								...
								<form method="post" action="national/subs_payment_update_process">
									<table class="table table-striped table-bordered table-condensed" id="sample_1">

									<tr>
										<td><b>Payment Method</b></td>
										<td><?php echo $paymentdetails['Mode_of_pay'];?><input type="hidden"  name="id" value="<?php echo $paymentdetails['id'];?>"/><input type="hidden"  name="urlids" value="<?php echo $orderid.'#'.$subsid.'#'.$distid;?>"/></td>
									</tr>
									<tr>
