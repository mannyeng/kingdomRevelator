        ...
        <ul class="breadcrumb">
          ...
          <li>
           ...
           <li>
            ...
            <a href="national/distributers_payment/<?php echo $this->uri->segment(4).'/'.$this->uri->segment(5).'/'.$this->uri->segment(6);?>">Orders</a>
...
if($row['refund_status']==1)
 ...
 echo '<td>'.$row['refund_date'].'</td>';
  ...
  <?php if(($row['Mode_of_pay'] == 'cash') || ($row['Mode_of_pay'] == 'cheque') || ($row['Mode_of_pay'] == 'Cash') || ($row['Mode_of_pay'] == 'Cheque')) {?>
         <a href="javascript:;" onclick="get_modal('<?php echo $row['id'];?>','<?php echo $orders['id'];?>','<?php echo $this->uri->segment(4);?>','<?php echo $this->uri->segment(5);?>','<?php echo $distributer;?>')" class="btn btn-danger">Payment Update</a>&nbsp;
         <?php }?>

         <a href="javascript:;" onclick="get_modal1('<?php echo $row['id'];?>','<?php echo $orders['id'];?>','<?php echo $this->uri->segment(4);?>','<?php echo $this->uri->segment(5);?>','<?php echo $distributer;?>')" class="btn btn-danger">Refunds</a>
         <?php
...
<script>
 ...
 function get_modal(paymentid,orderid,distcode,zoneid,distid){

        $.ajax({

            type    : 'POST', 

            data  : 'paymentid='+paymentid+'&orderid='+orderid+'&distcode='+distcode+'&zoneid='+zoneid+'&distid='+distid,   

            url     : '<?php base_url() ?>national/dist_modal_payment_update',
    ...
    function get_modal1(paymentid,orderid,distcode,zoneid,distid){
        ...
        $.ajax({
           ...
           data  : 'paymentid='+paymentid+'&orderid='+orderid+'&distcode='+distcode+'&zoneid='+zoneid+'&distid='+distid, 
            ...
            url     : '<?php base_url() ?>national/dist_modal_refund_update',
