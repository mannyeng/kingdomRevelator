...
<div class="col-lg-12 col-md-12 padding-zero">
        <div class="well bs-component">
            ...
            <fieldset>
              <legend><center>GIFT SUBSCRIBER'S INFORMATION</center></legend>
             <div id='message'><?php if($this->session->flashdata('alert')=='fails'){ ?><div class="alert alert-dismissible alert-danger"><button type="button" class="close" data-dismiss="alert">×</button>Email already exist.  <a href="javascript:void(0)" class="alert-link"></a></div><?php } if($this->session->flashdata('alert')=='success'){ ?><div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button>You have <strong>Subscribed</strong> successfully.  <a href="javascript:void(0)" class="alert-link"></a></div><?php } ?></div>
              <div class="col-lg-12" style="margin-left: 0%;z-index:1;">
                  ...
                  <div class="form-group">
                      <div class="col-lg-10 col-md-10 col-lg-offset-1">
                        <input type="text" class="form-control" id="First_name" name='First_name' value="" placeholder=" Gift To(First Name)">
                      </div>
                  </div>
                  <div class="form-group ">
                      <div class="col-lg-10 col-md-10 col-lg-offset-1">
                        <input type="text" class="form-control" id="Last_name" name='Last_name' value="" placeholder=" Gift To(Last Name)">
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="col-lg-10 col-md-10 col-lg-offset-1">
                        <input type="text" class="form-control" id="Address1" name='Address1' value="" placeholder=" Gift Mailing Address1 example : 766 Mary st">
                      </div>
                  </div>
              </div>
              ...
              <div class='col-lg-12' style="z-index:1;">
                  <div class="form-group">
                      <div class="col-lg-10 col-md-10 col-lg-offset-1">
                        <input type="text" class="form-control" id="Address2" name='Address2' value="" placeholder="Gift Mailing Address2 example : unit 2Bt">
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="col-lg-10 col-md-10 col-lg-offset-1">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                      <div class="col-lg-10 col-md-10 col-lg-offset-1">
                        <input type="email" class="form-control" id="Email" name='Email' value="" autocomplete="off"  placeholder=" Email Address" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8 col-md-10" style="display: inline-flex;padding-top: 2%;">
                  ...
                  <div id='payment_type_cheque' style="display:none">
                      <div class="form-group">
                          <div class="col-lg-10 col-md-10 col-lg-offset-1">
                            <input type="text" class="form-control" id="cheque_agent_name" name="cheque_agent_name" placeholder="Please enter the agent name,Cheque number"  />
                          </div>
                      </div>
                      <div class="form-group">
                          <div class="col-lg-10 col-md-10 col-lg-offset-1">
