...
mysql_select_db('kr_db',$con);
if(isset($_REQUEST['id']))
{
	$id=$_REQUEST['id'];

	$result=mysql_fetch_assoc(mysql_query("SELECT * FROM kr_books WHERE md5(id)='$id'"));
}
?>
    ...
    <div class="PDFF" id="PDFF">      
        ...
        <section id="config">
          <ul>
            ...
            <li key="pdf_url">../pdf/<?php echo $result['file'];?></li>		     
        ...
        <div id="PDFF-footer">
            ...
            <a id="PDFF-logo" target="_blank" href="http://www.pdf-flip.com">
                <img alt="Client Logo" src="logo.png" style='width:36%;'>
            </a>
            ...
            <div class="PDFF-menu" id="PDFF-right">
                <ul>              
                    ...
                    <li><a title="Download PDF" class="PDFF-download" href="../pdf/<?php echo $result['file'];?>"><i class="fa fa-file-pdf-o"></i></a></li>               
                </ul>
            </div>
